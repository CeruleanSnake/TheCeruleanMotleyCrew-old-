...
const loadCommentary = () => {
    ...
    const oldCommentaryDOM = document.querySelector("#commentary-posted")
    if (oldCommentaryDOM) oldCommentaryDOM.remove();
...
MSPFA.slide.push(loadCommentary);
if (MSPFA.story.i !== 34652) {
    loadCommentary();
}